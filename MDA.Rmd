...
ggplot(summaryTests, aes(x = prep, y = pcalDir))+
  geom_point(alpha = .25)+
  coord_cartesian(xlim= c(0,1),ylim= c(0,1))+
  geom_hline(yintercept = .05)
...
# discrepancy between the reported and recalcualted p-values
### Exact Format
...
plot(z, CI = TRUE, annotation = TRUE, main = "2008-2020 - Two-sided TEsts (Figure 6B)")


plot(zD, CI = TRUE, annotation = TRUE, main = "2008-2020 - Both (Figure 6A)")
...
grid.arrange(arrangeGrob(rHandcodedH+ theme(legend.position = "none"),  rHandcodedM+ theme(legend.position = "none"), top =textGrob("Handcoded Articles", gp = gpar(fontsize = 20, fontface = "bold")), ncol = 1),
