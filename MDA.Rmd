...
NPCall = ggplot(summaryTests, aes(y = Npc, x= Year, col = Journal, group = Journal, shape = Journal))+
  geom_point(position = position_jitterdodge(jitter.width = .1, dodge.width = 1), alpha = .02, na.rm = TRUE) +
  stat_summary(fun = "median", geom = "line",position = position_dodge(width = .6), na.rm = TRUE, size = 1)+
  stat_summary(fun.data = "median_hilow", fun.args=list(conf.int=0.5),geom = "pointrange",position = position_dodge(width = 1), na.rm = TRUE, size = .75)+
  coord_cartesian(ylim= c(0,500))+
  scale_color_manual(values = c("red","blue","orange"), label= c("JCP", "JCR", "JMR"), name = "Journal")+
  scale_shape_manual(values = c(15,16,17), label= c("JCP", "JCR", "JMR"), name = "Journal")+
...
rAll = ggplot(summaryTests, aes(y = r, x= Year, fill = Journal, col = Journal, group = Journal, shape = Journal))+
  stat_summary(fun = "median", geom = "line",position = position_dodge(width = 1), na.rm = TRUE, size = .75)+
  stat_summary(fun.data = "median_hilow", fun.args=list(conf.int=0.5),geom = "pointrange",position = position_dodge(width = 1), na.rm = TRUE, size = .75)+
  scale_shape_manual(values = c(15,16,17), label= c("JCP", "JCR", "JMR"), name = "Journal")+
  ...
  geom_point(position = position_jitterdodge(jitter.width = .1, dodge.width = 1), alpha = .025, na.rm = TRUE, aes(col = Journal, shape = Journal)) +
  scale_x_discrete(name = "Year", breaks = c(11,12,13,14,15,16,17,18), labels = c("2011","2012","2013","2014","2015","2016","2017","2018"))+
                theme_classic()+  
                #ggtitle("Effect Size")+
                theme(tex = element_text(size=12),
